...
export default function About() {
  return (
    <div className="flex flex-col justify-between px-5 lg:px-28 lg:flex-row" id="about">
      <motion.div
        className="lg:w-1/2"
      ...
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <h2 className="mt-4 text-2xl lg:text-4xl lg:mt-0">
        ...
        <p className="text-[#71717A] text-sm/6 lg:text-base mt-3 lg:mt-5">
          My web development journey started in **2024**, and since then, I've continuously evolved, taking on new challenges and keeping up with the latest technologies. Today, I build **cutting-edge web applications** using **React, Javascript, TailwindCSS, and more**.
        </p>
